...
class WirelessProductDetailsScreen extends Component{
  ...
  render(){
    ...
    return(
      <View style={{flex: 1, flexDirection: 'column',padding: 20, }}>
        <ScrollView>
        <Text style={styles.textstyle}>Wireless Cctv Camera</Text>
        ...
        <View style={{flexDirection: 'column',padding: 10, }}>
          <Text style={styles.subtext}>Wireless Cctv Camera</Text>
...
export default WirelessProductDetailsScreen;
