...
class HikvisionProductDetailsScreen extends Component{
  ...
  render(){
    ...
    return(
      <View style={{flex: 1, flexDirection: 'column',padding: 20, }}>
        <ScrollView>
        <Text style={styles.textstyle}>Hikvision Cctv Demo Camera</Text>
...
export default HikvisionProductDetailsScreen;
